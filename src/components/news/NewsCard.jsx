    ...
    <div className="pt-40">
      <Link href={link} target="_blank" rel="noreferrer">
        <div className="news-card card flex flex-col rounded-35 max-w-[382px] items-center text-center">
          <div className="top w-[335px] h-[251px] flex items-center justify-center rounded-50 overflow-hidden -mt-[35%]">
            <img
              src={image_url}
              alt=""
          ...
          <div className="center mt-[22px] mx-[41px]">
            <h2 className="text-xl text-blue mb-[14px] news-card-title">{title} </h2>
